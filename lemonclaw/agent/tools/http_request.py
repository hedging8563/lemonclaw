...
from lemonclaw.agent.tools.web import MAX_REDIRECTS, USER_AGENT
...
async def _execute_http_request(
    *,
    ...
    """Shared HTTP execution with redirect tracking.
...
class HTTPRequestTool(Tool):
    ...
    def description(self) -> str:
        return (
            "Perform a structured HTTP request to an http/https endpoint. "
