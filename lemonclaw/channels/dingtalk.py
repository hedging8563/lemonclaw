...
class LemonClawDingTalkHandler(CallbackHandler):
    """
    Standard DingTalk Stream SDK Callback Handler.
    Parses incoming messages and forwards them to the LemonClaw channel.
    """
...
class DingTalkChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            handler = LemonClawDingTalkHandler(self)
