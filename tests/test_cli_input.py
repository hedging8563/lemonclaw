...
from lemonclaw.cli import commands
...
def mock_prompt_session():
    ...
    with patch("lemonclaw.cli.commands._PROMPT_SESSION", mock_session), \
         patch("lemonclaw.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("lemonclaw.cli.commands.PromptSession") as MockSession, \
         patch("lemonclaw.cli.commands.FileHistory") as MockHistory, \
